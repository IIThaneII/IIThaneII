...
def add_cafe():
    ...
    if form.validate_on_submit():
        with open("/Users/ez/OneDrive/Máy tính/codeprojects/PYTHON/100_days_of_Py/15_day(59-62)/coffee-and-wifi/cafe-data.csv", mode="a", encoding="utf-8") as csv_file:
            csv_file.write(f"\n{form.cafe.data},"
...
@app.route('/cafes')
def cafes():
    with open('/Users/ez/OneDrive/Máy tính/codeprojects/PYTHON/100_days_of_Py/15_day(59-62)/coffee-and-wifi/cafe-data.csv', encoding="utf8", newline='') as csv_file:
